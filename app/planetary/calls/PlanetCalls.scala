package planetary.calls

import db.connection.DBComponent
//import db.repos.{InvgroupsRepo, InvtypesRepo, InvtypematerialsRepo, InvmarketgroupsRepo}
import db.repos.{PlanetschematicstypemapRepo, InvtypesRepo, PlanetaryResourcesTypeMapRepo}
import scala.concurrent.Future
import scala.concurrent.ExecutionContext.Implicits.global
import play.api.libs.json._
//import scrap.jsonapi.ScrapJsonApi.{Component, TypeInfo}
import scrap.jsonapi.ScrapJsonApi._

import planetary.jsonapi.PlanetaryJsonApi.{SchematicRow, SchematicRecipe, ItemDetails}//, PlanetResourceMap}

trait PlanetCalls 
//      extends InvgroupsRepo 
//      with InvtypesRepo 
//      with InvtypematerialsRepo 
//      with InvmarketgroupsRepo
        extends PlanetschematicstypemapRepo
        with InvtypesRepo
